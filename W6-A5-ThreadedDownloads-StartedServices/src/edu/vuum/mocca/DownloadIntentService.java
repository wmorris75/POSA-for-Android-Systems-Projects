...
public class DownloadIntentService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
    	...
    	Intent intent = DownloadUtils.makeMessengerIntent(context, DownloadIntentService.class,
    			handler, uri);
    ...
    protected void onHandleIntent (Intent intent) {
    	...
    	//Creates messenger object to be passed as a parameter in DownloadUtils.downloadAndRespond(...)
